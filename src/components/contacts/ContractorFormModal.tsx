        ...
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-[var(--app-border)] bg-[rgba(246,247,243,0.96)] px-6 py-5 backdrop-blur">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-[var(--app-text-muted)]">
              Save GCs once so future bids can use clean linked company records.
            </p>
          </div>
          <button
          ...
          <section className="rounded-[24px] border border-[var(--app-border)] bg-[var(--app-surface)] p-5 shadow-sm">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <label className="flex flex-col gap-2 md:col-span-2">
                <span className="text-sm font-semibold text-[var(--app-text)]">Name *</span>
                <input
              ...
              <label className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-[var(--app-text)]">Website</span>
                <input
                  className="min-h-11 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-muted)] px-4 text-sm outline-none transition focus:border-[var(--app-primary)] focus:bg-white"
                  disabled={submitting}
              ...
              <label className="flex flex-col gap-2">
                <span className="text-sm font-semibold text-[var(--app-text)]">Main Phone</span>
                <input
                  className="min-h-11 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-muted)] px-4 text-sm outline-none transition focus:border-[var(--app-primary)] focus:bg-white"
                  disabled={submitting}
              ...
              <label className="flex flex-col gap-2 md:col-span-2">
                <span className="text-sm font-semibold text-[var(--app-text)]">Main Email</span>
                <input
                  className="min-h-11 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface-muted)] px-4 text-sm outline-none transition focus:border-[var(--app-primary)] focus:bg-white"
                  disabled={submitting}
